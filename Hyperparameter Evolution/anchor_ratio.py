# @Time: 2021/11/28 19:57
# @Author: Chen Chao
# @File: anchor_ratio.py
# @Software: vscode
...
# 读取数据
ann_json = 'F:/数据集/voc2coco-master/transmission_line_detection/annotations/instances_train.json'
